      ...
      {overviewData.map((item, index) => (
        <motion.div
          ...
          className="dark:bg-gray-800 bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg
            rounded-xl p-6 border dark:border-gray-700 border-gray-200
          "
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-medium dark:text-gray-400 text-gray-500">{item.name}</h3>
              <p className="mt-1 text-xl font-semibold dark:text-gray-100 text-gray-900">
                {item.value}
              </p>
            </div>
